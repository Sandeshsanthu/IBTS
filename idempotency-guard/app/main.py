...
# filename: idempotency-guard/app/main.py
...
from prometheus_fastapi_instrumentator import Instrumentator   # â† ADD
...
Instrumentator().instrument(app).expose(app)            # â† ADD
